<x-filament-panels::page>
    @php
        ...
        $pageTitle = $this->getTitle() ?? 'Edit ' . $recordTitle;
    ...
    <style>
        ...
        .form-header-text h1 { font-size: 18px; font-weight: 700; color: var(--text); margin: 0; display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
        .form-header-text h1 small { font-size: 12px; font-weight: 500; color: var(--text-muted); }
            ...
            <div class="dash-content">
                ...
                <div class="form-header">
                    <div class="form-header-left">
                        <a href="{{ $indexUrl }}" class="form-back-btn" title="Back to list">
