<x-filament-panels::page>
    @php
        $user = $this->getRecord();
        $avatarUrl = $user->avatar_url ? asset('storage/' . $user->avatar_url) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=091c3d&color=fff&size=200';
    ...
    <style>
        ...
        .vp-avatar { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid var(--accent-light); flex-shrink: 0; }
    ...
    <div id="dash" x-data="{ mobileSidebar: false }">
        <x-admin.dash-layout :title="$user->name">
            <div class="dash-content">
                ...
                <div class="vp-profile-card">
                    <img src="{{ $avatarUrl }}" alt="{{ $user->name }}" class="vp-avatar">
